...
const Icon = {
  ...
  plug: <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round"><path d="M12 22v-5M9 7V2M15 7V2M10 17H5a2 2 0 01-2-2v-4h18v4a2 2 0 01-2 2h-5"/><path d="M9 7h6"/></svg>,
      ...
      <div ref={wrapRef} style={{ display: 'flex', alignItems: 'center', gap: 6, position: 'relative' }}>
        ...
        {open === 'help' && (
          <div className="topbar-drop" style={{ right: 140 }}>
            ...
            <a href="mailto:hola@novu.uy" className="topbar-drop__item" onClick={() => setOpen(null)}>
