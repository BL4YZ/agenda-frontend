...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
    return (
        <html lang="es" suppressHydrationWarning>
            ...
            <body className={`${inter.className} ${jetbrainsMono.variable} bg-slate-50 dark:bg-[#07090f] text-slate-900 dark:text-white antialiased transition-colors duration-300`}>
                {/* Ambient glow orbs */}
